...
onready var info_laser: ContenedorInformacionEnergia = $ContenedorInformacionEnergiaLaser
onready var info_escudo: ContenedorInformacionEnergia = $ContenedorInformacionEnergiaEscudo
